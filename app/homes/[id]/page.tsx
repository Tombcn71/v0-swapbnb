  ...
  useEffect(() => {
    async function fetchHome() {
      try {
        ...
        if (!res.ok) {
          console.error(`Failed to fetch home: ${res.status} ${res.statusText}`)
          ...
          <Card className="sticky top-4">
            <CardContent className="p-6">
              ...
              <p className="text-gray-600 mb-6">
                Neem contact op met {home.host_name} om de mogelijkheden voor een huizenruil te bespreken.
              </p>
              <HomeContact ownerId={home.user_id} ownerName={home.host_name} homeId={home.id} />
            </CardContent>
          </Card>
        </div>
      </div>
