...
export default async function DashboardPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <h2 className="text-2xl font-bold mb-4">Uitwisselingen</h2>
      <Card>
        <CardContent className="p-6">
          <p className="text-gray-600">Je hebt nog geen uitwisselingen</p>
          <Button asChild className="mt-4">
            <Link href="/exchanges">Bekijk uitwisselingen</Link>
          </Button>
        </CardContent>
      </Card>
    </div>
