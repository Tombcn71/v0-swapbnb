      ...
      <div className="flex flex-wrap gap-4">
        ...
        {images.length < maxImages && !uploading && (
          <button
            ...
            className="w-32 h-32 rounded-md border-2 border-dashed border-gray-300 flex flex-col items-center justify-center hover:border-primary transition-colors"
          >
